...
const VolaryContract = new ethers.Contract(VolaryContractAddress, volaryABI, signer);
const StakingContract = new ethers.Contract(StakingContractAddress, stakingABI, signer);
const RewardContract = new ethers.Contract(RewardPoolContractAddress, rewardPoolABI, signer);
...
app.get("/AddRewardPool", async (req, res) => {
    ...
    res.send(addRewardPoolAddressfunc,approvefunc);
  });

app.post("/CreateStake", async (req,res) =>{
    const stake_amount = req.body.amount;
    const duration = req.body.duration;
    const createStakefunc = await StakingContract.createStake(stake_amount,duration)
    res.send(createStakefunc)
});

app.post("/getBalanceofStaker", async (req,res) =>{
    const indexedAddress = req.body.index;
    const balanceOfStaker = await StakingContract.getStakeAmount(indexedAddress);
